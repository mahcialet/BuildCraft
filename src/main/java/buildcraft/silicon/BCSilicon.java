...
public final class BCSilicon {
    ...
    public BCSilicon(IEventBus modBus, ModContainer modContainer) {
        modContainer.registerConfig(ModConfig.Type.CLIENT, BCSiliconConfig.SPEC);
    ...
    private void addCreativeTabContents(BuildCreativeModeTabContentsEvent event) {
        ...
        BCSiliconItems.facadeVariants().forEach(event::accept);
        BCSiliconItems.lensVariants().forEach(event::accept);
