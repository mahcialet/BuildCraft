...
public enum GateAction implements StringRepresentable {
    ...
    FILLER_SPHERE,
    FILLER_HEMISPHERE,
    FILLER_QUARTER_SPHERE,
    FILLER_EIGHTH_SPHERE,
    FILLER_ARC,
    FILLER_CIRCLE,
    FILLER_HEXAGON,
    FILLER_OCTAGON,
    ...
    ROBOT_WAKE_UP,
    ROBOT_WORK_AREA,
    ROBOT_LOAD_UNLOAD_AREA,
    ROBOT_FILTER,
    ROBOT_FILTER_TOOL,
    STATION_REQUEST_ITEMS,
    STATION_PROVIDE_ITEMS,
    STATION_ACCEPT_FLUIDS,
    STATION_PROVIDE_FLUIDS,
    STATION_FORCE_ROBOT,
    STATION_FORBID_ROBOT,
    STATION_ACCEPT_ITEMS,
    STATION_MACHINE_REQUEST_ITEMS;
