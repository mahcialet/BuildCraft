...
public final class BCBuildersMenus {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<FillerPlannerMenu>> FILLER_PLANNER =
            MENUS.register("filler_planner", () -> IMenuTypeExtension.create(FillerPlannerMenu::new));
